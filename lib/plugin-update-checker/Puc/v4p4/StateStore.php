...
if ( !class_exists('Puc_v4p4_StateStore', false) ):
	...
	class Puc_v4p4_StateStore {
		 ...
		 * @return $this
		 */
		public function setAmVersion($version) {
			$this->lazyLoad();
			$this->amVersion = strval($version);
			return $this;
		}
		...
		public function save() {
			...
			$state->amVersion = $this->amVersion;
		...
		protected function load() {
			...
			$this->amVersion = Puc_v4p4_Utils::get($state, 'amVersion', '');
			$this->update = null;
